    ...
    <Container>
      ...
      >
        ...
        >
          ...
          <h2>
            <span style={{ color: "#7764E8" }}>Task</span> Flow
        ...
        <StyledMenuItem
          translate="no"
          onClick={() => {
            window.open("https://github.com/faithful1ofall/TaskFlow");
          }}
        >
          <GitHub /> &nbsp; Github{" "}
          {stars && (
        ...
        <StyledMenuItem
          onClick={() => {
            window.open("https://github.com/faithful1ofall/TaskFlow/issues/new");
          }}
        >
        ...
        >
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/faithful1ofall"
            >
              faithful & sugar
            </a>
          </CreditsContainer>
